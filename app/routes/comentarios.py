...
@mensagem_existe
def get_comments(mensagem_id):
    comments = comment_controller.listar_comentarios(mensagem_id)
    return comments_schema.jsonify(comments), 200

@comentarios_bp.route('/mensagens/<int:mensagem_id>/comentarios/<int:comment_id>', methods=['GET'])
@mensagem_existe
@comentario_existe
...
@comentarios_bp.route('/mensagens/<int:mensagem_id>/comentarios/<int:comment_id>', methods=['PUT'])
@jwt_required()
@mensagem_existe
@comentario_existe
...
@comentarios_bp.route('/mensagens/<int:mensagem_id>/comentarios/<int:comment_id>', methods=['PATCH'])
@jwt_required()
@mensagem_existe
@comentario_existe
...
@comentarios_bp.route('/mensagens/<int:mensagem_id>/comentarios/<int:comment_id>', methods=['DELETE'])
@mensagem_existe
@comentario_existe
@jwt_required()
